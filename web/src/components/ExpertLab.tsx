...
import { Explain, ExplainerProvider } from "./Explainer";
import { ForkDiff } from "./ForkDiff";
import { CARD_HOME, CONCEPTS, type ExplainCtx } from "./Explanations";
...
/* The expert stack — the whole lab on one page, reachable at ?view=expert.
   Split out of App.tsx so the default flow ships without it (it code-splits
